...
PROBE_SCOPE_RAM_FUNC void  ProbeScope_Sampling (void);
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_ModeOff (void);
static  void  ProbeScope_ModeOff (void)
{
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_ModeContinuous (void);
static  void  ProbeScope_ModeContinuous (void)
{
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_ModeTrig (void);
static  void  ProbeScope_ModeTrig (void)
{
    if (ProbeScope_SamplingClkDivCtr > 1) {
        ProbeScope_SamplingClkDivCtr--;
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_SampleChAll (void);
static  void  ProbeScope_SampleChAll (void)
{
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_SampleCh (PROBE_SCOPE_CH  *p_ch);
static  void  ProbeScope_SampleCh (PROBE_SCOPE_CH  *p_ch)
{
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_SamplePosNext (void);
static  void  ProbeScope_SamplePosNext (void)
{
...
PROBE_SCOPE_RAM_FUNC static  void  ProbeScope_IsTrig (void);
static  void  ProbeScope_IsTrig (void)
{
    PROBE_SCOPE_CH          *p_ch;
